...
AS BEGIN
	...
	@serial_name_ow BIT, @cut_sheet_filename VARCHAR(100), @final_disposition VARCHAR(200), @delivered_date date, @received_date date,
	...
	@serial_number_ow = serial_number_ow, @serial_name = serial_name, @serial_name_ow = serial_name_ow, @cut_sheet_filename = cut_sheet_filename,
